                ...
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Update Data
                            Laundry</h5>
                        <form action="/postEditLaundry/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mt-4">
                                <label class="text-secondary mb-2">Kode Laundry</label>
                                <input type="text" class="form-control"
                                    name="kode_laundry" required value="{{ $data->kode_laundry }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control"
                                    name="nama_laundry" required value="{{ $data->nama_laundry }}">
                                <span class="text-danger">
                                    @error('nama_laundry')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control"
                                    name="alamat" required value="{{ $data->alamat }}">
                                <span class="text-danger">
                                    @error('alamat')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="deskripsi" placeholder="Edit Deskripsi disini "
                                    style="height: 250px" required value="{{ $data->deskripsi }}"></textarea>
                            </div><br>
                            <div class="form-group mt-1">
                            ...
                            <button type="submit" class="btn btn-success mt-5">Update data Laundry</button>
                            </div>
                        </form>
                    </div>
                </div>
