...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-center">Tambah Layanan</h5>
                <form action="{{ route('postTambahLayanan') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-3">
                        <label for="jenis" class="form-label">id Cabang</label>
                    ...
                    <button type="submit" class="btn btn-success">Tambah Data Layanan</button>
                </form>
            </div>
        </div>
    </div>
