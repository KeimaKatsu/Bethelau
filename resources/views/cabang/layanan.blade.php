...
<body>
        ...
        <div class="container" style="margin-top: auto">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto" style="margin-top: 5px">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-semibold" href="{{ route('cabang.layanan') }}"
                            style="color: #060355; margin-right: 10px;">Layanan</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-3">
        ...
        <div class="col">
                <form action="{{ route('cabang.layanan') }}" method="GET" class="input-group">
                    @csrf
        ...
        <div id="fixedButton" class="col-2 ms-auto" style="margin-top: 20px;">
            <a class="btn text-light" href="{{ route('cabang.tambahLayanan') }}">
        ...
        <div class="row mt-4">
            ...
            <tbody class="table" style="border: #009CE1;">
                @foreach ($data as $index => $layanan)
                <tr>
                    <td scope="row">{{ $index + $data->firstItem() }}</td>
                    <td>{{ $layanan->id_user }}</td>
                    <td>{{ $layanan->jenis }}</td>
          
                    <td>{{ $layanan->harga}}</td>
                    <td>
                            <a class="btn3 " href="/cabang/editLayanan/{{ $layanan->id }}">
                                <img src="{{ asset('image/edit.png') }}" alt="Edit Icon" style="width: 35px; height: 35px;">
                            </a>
                            <a class="btn3 " href="/cabang/deleteLayanan/{{ $layanan->id }}">
